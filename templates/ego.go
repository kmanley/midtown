...
_, _ = fmt.Fprintf(w, "%v", job.StateString())
//line activejobs.ego:27
_, _ = fmt.Fprintf(w, "</td>\n\t\t\t<td>")
...
//line activejobs.ego:32
_, _ = fmt.Fprintf(w, "</td>\n\t\t</tr>\n\t\t")
//line activejobs.ego:34
	
		}
		
//line activejobs.ego:37
_, _ = fmt.Fprintf(w, "\n\t</table>\n\n  </body>\n</html>")
return nil
}
...
//line completedjobs.ego:34
_, _ = fmt.Fprintf(w, "</td>\n\t\t</tr>\n\t\t")
//line completedjobs.ego:36
	
		}
		
//line completedjobs.ego:39
_, _ = fmt.Fprintf(w, "\n\t</table>\n\n  </body>\n</html>")
return nil
}
//line error.ego:1
...
_, _ = fmt.Fprintf(w, "</td>\n\t\t\t<td>")
//line job.ego:58
_, _ = fmt.Fprintf(w, "%v", task.Elapsed().String())
//line job.ego:58
_, _ = fmt.Fprintf(w, "</td>\n\t\t\t<td>")
//line job.ego:59
